...
//            int serialSize = (int) ((Math.random() * Ewoks) + 1);
    ...
    public List<Integer> shuffleArray(List<Integer> list) {
        ...
        int randLength = (int) (Math.random() * ar.length);
    ...
    public void runTest() throws IOException {
        ...
        a1.add(1); a1.add(3); a1.add(2);
//        a1.add(4); a1.add(9); a1.add(2); a1.add(5); a1.add(7); a1.add(6);
        Attack a = new Attack(a1, 5366);
        List<Integer> b1 = new LinkedList<>();
        b1.add(1);
//        b1.add(2); b1.add(6); b1.add(7); b1.add(5); b1.add(3); b1.add(4);
        Attack b = new Attack(b1, 2439);
        List<Integer> c1 = new LinkedList<>();
        c1.add(4); c1.add(1); c1.add(2);
//        c1.add(7); c1.add(3); c1.add(4); c1.add(6);
        Attack c = new Attack(c1, 817);
        List<Integer> d1 = new LinkedList<>();
        d1.add(1);
//        d1.add(5); d1.add(7); d1.add(9); d1.add(3); d1.add(4); d1.add(8); d1.add(6); d1.add(2);
        Attack d = new Attack(d1, 3365);
        List<Integer> e1 = new LinkedList<>();
        e1.add(1);
//        e1.add(7); e1.add(5); e1.add(1); e1.add(2); e1.add(3); e1.add(6);
        Attack e = new Attack(e1, 769);
        List<Integer> f1 = new LinkedList<>();
        Attack f = new Attack(f1, 3537);
        List<Integer> g1 = new LinkedList<>();
        g1.add(1); g1.add(2);
        Attack g2 = new Attack(g1, 3498);
        Attack[] a2 = new Attack[7];
        a2[0] = a; a2[1] = b; a2[2] = c; a2[3] = d; a2[4] = e; a2[5] = f; a2[6] = g2;
        GeneratedInput g = new GeneratedInput(a2, 3481, 4141, 4);
        toTest(g,1);
    }
...
//        System.out.println("Lando arrived");
        ...
        System.out.println("start time set for test number: " + iter);
